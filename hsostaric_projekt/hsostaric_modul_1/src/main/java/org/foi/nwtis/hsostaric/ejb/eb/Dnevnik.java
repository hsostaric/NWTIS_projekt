...
public class Dnevnik implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 100)
    @Column(name = "URL_ADRESA", nullable = false, length = 100)
    ...
    @Size(max = 100)
    @Column(name = "IP_ADRESA", length = 100)
    ...
    public Dnevnik(Integer id, String urlAdresa, Date vrijemePrijema, int trajanjeObrade) {
        this.id = id;
    ...
    public String toString() {
        return "org.foi.nwtis.hsostaric.ejb.eb.Dnevnik[ id=" + id + " ]";
    }
