...
import org.foi.nwtis.hsostaric.dretve.GlavnaDretva;
import static org.foi.nwtis.hsostaric.dretve.GlavnaDretva.radi;
...
public class SlusacAplikacije implements ServletContextListener {
    ...
    private GlavnaDretva glavnaDretva = null;
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        glavnaDretva = new GlavnaDretva(konf);
        glavnaDretva.start();
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        if (glavnaDretva != null) {
            glavnaDretva.interrupt();
        }
        radi = false;
